    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
              ...
              className='lg:col-span-2'>
                ...
                md:max-h-100 object-cover rounded-xl mb-6 shadow-md' />
                <motion.div
                 initial={{opacity:0,}}
                 animate={{opacity:1}}
                  ...
                  <div className='grid grid-cols-2 sm:grid-cols-4 gap-2'>
                    {[
                      ...
                      key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                        <img src={icon} alt="car image" className='h-5 mb-2' />
                        {text}
              ...
              text-gray-500 '>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <input value={pickupDate} onChange={(e)=> setPickupDate(e.target.value)}
                   type='date' className='border border-borderColor px-3
                  py-2 rounded-lg ' required id='pickup-date' min={new Date().toISOString().split("T")[0]} />
                </div>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='return-date'>Return Date</label>
                  <input value={returnDate} onChange={(e)=> setReturnDate(e.target.value)}
                  type='date' className='border border-borderColor px-3
                  py-2 rounded-lg ' required id='return-date'  />
                </div>
