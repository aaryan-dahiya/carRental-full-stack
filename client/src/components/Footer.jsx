...
const Footer = () => {
  return (
   ...
   className='x-6 max-sm:px-10 md:px-17 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <motion.div
            ...
            className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor  md:gap-6'>
                <div>
                    ...
                    className='flex items-center gap-3 mt-4'>
                        <a href="#"><img src={assets.facebook_logo} alt="" className='w-5
                        h-5 ' /></a>
                        <a href="#"><img src={assets.instagram_logo} alt="" className='w-5
                        h-5 ' /></a>
                        <a href="#"><img src={assets.twitter_logo} alt="" className='w-5
                        h-5 ' /></a>
                        <a href="#"><img src={assets.gmail_logo} alt="" className='w-5
                        h-5 ' /></a>
