...
const Testimonial = () => {
  const testimonials = [
    ...
    },
    {
      ...
      image: assets.testimonial_image_1,
      testimonial:
        "I highly recommend CarRental! Their fleer is amazing, and I always feel like I' m getting the best  deal with excellent service.",
    },
  ];

  return (
    <div className="py-28 px-6 md:px-17 lg:px-24 xl:px-44">
      <Title
        title="What our customers says  "
        subTitle="Discover why discerning
        travelers choose stayventure for their luxuary accommodations around the 
        world"
      />
